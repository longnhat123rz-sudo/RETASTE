...
async function testOrderCreation() {
  try {
    ...
    const subtotal = "50000";  // String instead of number
    const shippingFee = "15000";  // String instead of number
    const total = "65000";  // String instead of number
    const paymentMethod = 'cash';
    const user = { id: "3" };  // String ID instead of number
